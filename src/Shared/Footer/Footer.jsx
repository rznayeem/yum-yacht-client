...
const Footer = () => {
  return (
    <div className="bg-[url(https://yummie.wpengine.com/wp-content/uploads/2023/12/Main-Footer-Pattern-Bg.jpg)] text-white bg-black/[.5] bg-blend-multiply">
      <footer className="text-center   lg:text-left">
        <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
          <Link
            to={'/'}
            className="mx-auto  bg-white/[.3] border-2 border-[#F67D12] p-5 rounded-lg hidden lg:block"
          >
