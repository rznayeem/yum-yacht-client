  ...
  return (
    <div className="mx-auto dark:bg-gray-100 dark:text-gray-800">
      <div className="flex relative flex-col mx-auto overflow-hidden rounded">
        ...
        <div className="flex flex-col lg:flex-row justify-around items-center p-5 md:p-20 lg:p-52 lg:m-4 mx-auto lg:-mt-48 space-y-6 sm:px-10 sm:mx-12 lg:rounded-3xl bg-[#F8F0E5]">
